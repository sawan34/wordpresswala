...
<html lang="en">
  <head>
		<title>Wordpresswala</title>
        <?php
           $dir_url =  get_bloginfo("template_directory");
         ?>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<link rel="stylesheet" type="text/css" href="<?php echo $dir_url; ?>/css/bootstrap.css">
		<link rel="stylesheet" type="text/css" href="<?php echo $dir_url; ?>/css/font-awesome.css">
		<link rel='stylesheet' id='camera-css'  href='<?php echo $dir_url; ?>/css/camera.css' type='text/css' media='all'>

		<link rel="stylesheet" type="text/css" href="<?php echo $dir_url; ?>/css/slicknav.css">
		<link rel="stylesheet" href="<?php echo $dir_url; ?>/css/prettyPhoto.css" type="text/css" media="screen" title="prettyPhoto main stylesheet" charset="utf-8" />
		<link rel="stylesheet" type="text/css" href="<?php echo $dir_url; ?>/css/style.css">
		
		
		<script type="text/javascript" src="<?php echo $dir_url; ?>/js/jquery-1.8.3.min.js"></script>

		<link href='http://fonts.googleapis.com/css?family=Roboto:400,300,700|Open+Sans:700' rel='stylesheet' type='text/css'>
		<script type="text/javascript" src="<?php echo $dir_url; ?>/js/jquery.mobile.customized.min.js"></script>
		<script type="text/javascript" src="<?php echo $dir_url; ?>/js/jquery.easing.1.3.js"></script> 
		<script type="text/javascript" src="<?php echo $dir_url; ?>/js/camera.min.js"></script>
		<script type="text/javascript" src="<?php echo $dir_url; ?>/js/myscript.js"></script>
		<script src="<?php echo $dir_url; ?>/js/sorting.js" type="text/javascript"></script>
		<script src="<?php echo $dir_url; ?>/js/jquery.isotope.js" type="text/javascript"></script>
		...
		<div class="container">
			<div class="row">
				<div class="logo col-md-4">
					<div>
						<a href="#">
							<img src="<?php echo $dir_url; ?>/images/logo.png">
						</a>
					</div>
				</div>
				<div class="col-md-8">
			...
			<div class="row wrap">
				<div class="col-md-12 gallery"> 
						<div class="camera_wrap camera_white_skin" id="camera_wrap_1">
							<div data-thumb="" data-src="<?php echo $dir_url; ?>/images/slides/blank.gif">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 centPic">
					<img class="img-responsive"  src="<?php echo $dir_url; ?>/images/bizPic.png"/>
				</div>
			</div>
		</div>   
    </div>
		...
		<div class="container">
			<div class="row team">
				<div class="col-md-4 b1">
						<img class="img-responsive" src="<?php echo $dir_url; ?>/images/picTeam/picT1.png">
						<h4>Tom Simpson</h4>
						<h5>CEO</h5>
				...
				<div class="col-md-4">
						<img class="img-responsive" src="<?php echo $dir_url; ?>/images/picTeam/picT2.png">
						<h4>John Doe</h4>
				...
				<div class="col-md-4 b3">
						<img class="img-responsive" src="<?php echo $dir_url; ?>/images/picTeam/picT3.png">
						<h4>Anna White</h4>
						<h5>Developer</h5>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit<br/> quisque tempus ac eget diam et laoreet phasellus ut nisi id leo molestie. adipiscing vitae vel quam proin eget mauris eget.</p>
						<ul>
		...
		<div style="position: relative;">
			...
			<div class="container">
				<div class="row about">
					<div class="col-md-6">
						<div class="about1">
						<img class="pic1Ab" src="<?php echo $dir_url; ?>/images/picAbout/aboutP1.png">
					...
					<div class="col-md-6">
						<div class="about2">
						<img class="pic2Ab" src="<?php echo $dir_url; ?>/images/picAbout/aboutP2.png">
			...
			<div class="container">
				<div class="row about">
					<div class="col-md-6">
						<div class="about1">
						<img class="pic1Ab" src="<?php echo $dir_url; ?>/images/picAbout/aboutP3.png">
					...
					<div class="col-md-6">
						<div class="about2">
						<img class="pic2Ab" src="<?php echo $dir_url; ?>/images/picAbout/aboutP4.png">
		...
		<div class="row">
			...
			<div class="portfolio_block columns3   pretty" data-animated="fadeIn">	
					<div class="element col-sm-4   gall branding">
						<a class="plS" href="<?php echo $dir_url; ?>/images/prettyPhotoImages/pic1.jpg" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/prettyPhotoImages/thumb_pic1.jpg" alt="pic1 Gallery"/>
						</a>
					...
					<div class="element col-sm-4  gall branding">
						<a class="plS" href="<?php echo $dir_url; ?>/images/prettyPhotoImages/pic2.jpg" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/prettyPhotoImages/thumb_pic2.jpg" alt="pic2 Gallery"/>
						</a>
					...
					<div class="element col-sm-4  gall web">
						<a class="plS" href="<?php echo $dir_url; ?>/images/prettyPhotoImages/pic3.jpg" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/prettyPhotoImages/thumb_pic3.jpg" alt="pic3 Gallery"/>
						</a>
						<div class="view project_descr ">
					...
					<div class="element col-sm-4  gall  text_styles">
						<a class="plS" href="<?php echo $dir_url; ?>/images/prettyPhotoImages/pic4.jpg" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/prettyPhotoImages/thumb_pic4.jpg" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr ">
					...
					<div class="element col-sm-4  gall  web">
						<a class="plS" href="<?php echo $dir_url; ?>/images/prettyPhotoImages/pic5.jpg" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/prettyPhotoImages/thumb_pic5.jpg" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr center">
					...
					<div class="element col-sm-4  gall  polygraphy">
						<a class="plS" href="<?php echo $dir_url; ?>/images/prettyPhotoImages/pic6.jpg" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/prettyPhotoImages/thumb_pic6.jpg" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr ">
					...
					<div class="element col-sm-4   gall branding">
						<a class="plS" href="<?php echo $dir_url; ?>/images/prettyPhotoImages/pic7.jpg" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/prettyPhotoImages/thumb_pic7.jpg" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr ">
					...
					<div class="element col-sm-4  gall text_styles">
						<a class="plS" href="<?php echo $dir_url; ?>/images/prettyPhotoImages/pic8.jpg" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/prettyPhotoImages/thumb_pic8.jpg" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr ">
					...
					<div class="element col-sm-4  gall polygraphy">
						<a class="plS" href="<?php echo $dir_url; ?>/images/prettyPhotoImages/pic9.jpg" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/prettyPhotoImages/thumb_pic9.jpg" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr ">
    ...
    <div id="news">
		...
		<div class="container">
				<div class="row news">
					...
					<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/picNews/news1.jpg"/>
					...
					<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/picNews/news2.jpg"/>
			...
			<div class="container">
				<div class="row news2 news">
					<div class="col-md-6 text-left">
					<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/picNews/news3.jpg"/>
					<h3><a href="#">Lorem Ipsum Dolor sit Amet Pelenntesque Sodales!</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
					...
					<div class="col-md-6 text-right">
					<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/picNews/news4.jpg"/>
					<h3><a href="#">Nam in Nisl id Ipsum Feugiat Posuere ut sit Amet Sem</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
			...
			<div class="container">
				<div class="row news2 news">
					<div class="col-md-6 text-left">
					<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/picNews/news5.jpg"/>
					<h3 ><a href="#">Lorem Ipsum Dolor sit Amet Pelenntesque Sodales!</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
					...
					<div class="col-md-6 text-right">
					<img class="img-responsive picsGall" src="<?php echo $dir_url; ?>/images/picNews/news6.jpg"/>
					<h3><a href="#">Nam in Nisl id Ipsum Feugiat Posuere ut sit Amet Sem</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
	...
	<script src="<?php echo $dir_url; ?>/js/jquery.prettyPhoto.js" type="text/javascript" charset="utf-8"></script>
	<script src="<?php echo $dir_url; ?>/js/bootstrap.min.js"></script>
	<script src="<?php echo $dir_url; ?>/js/jquery.slicknav.js"></script>
	<script>
